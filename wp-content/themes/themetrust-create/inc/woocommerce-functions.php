...
function create_wc_redirect_to_checkout($cart) {
	global $woocommerce;
...
function woocommerce_header_add_to_cart_fragment( $fragments ) {
	...
	ob_start();
	?>
	<a class="cart-icon cart-contents right open" href="<?php echo wc_get_cart_url(); ?>" title="<?php _e('View your shopping cart', 'create'); ?>">
