...
function create_customize_register( $wp_customize ) {
	...
	*/
	...
	$wp_customize->add_section( 'create_header_cart', array(
		'priority'		 => 3,
	    'title'     	 => __( 'Cart', 'create' ),
		'panel'			=> 'create_header_navigation'
	) );
	
	$wp_customize->add_setting( 'create_enable_header_cart' , array(
	    'type' 				=> 'theme_mod',
	    'transport' 		=> 'refresh',
	    'sanitize_callback'	=> 'esc_html'
	) );
	
	$wp_customize->add_control( 'create_enable_header_cart', array(
		'type'      => 'select',
		'label'     => __( 'Show Cart Icon', 'create' ),
		'description'     => __( 'Shows the cart icon in the top header.', 'create' ),
		'section'   => 'create_header_cart',
		'settings'  => 'create_enable_header_cart',
		'choices'   => array(
					'yes' => 'Yes',
		            'no' => 'No'
		        ),
