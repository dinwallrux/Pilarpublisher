...
class TTrust_Portfolio extends WP_Widget {
	...
	public function widget( $args, $instance ) {
			...
			if($instance['hover_effect']=="effect-4") {
				wp_enqueue_script( 'create-hover-3d' );
			}
			?>
...
<?php
	...
	function form( $instance ) {
		...
		<?php
		$options = array('Effect 1' => 'effect-1', 'Effect 2' => 'effect-2', 'Effect 3' => 'effect-3', '3D Hover' => 'effect-4');
		foreach ($options as $option=>$value) {
