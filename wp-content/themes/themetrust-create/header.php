...
$show_header_cart             = get_theme_mod( 'create_enable_header_cart' );
...
$header_transparent_bg = (get_post_meta( $id, '_create_header_transparent_bg', true ) == "yes") ? "transparent " : "solid ";
...
$header_class .= $header_transparent_bg;
...
<body <?php body_class($header_transparent_bg); ?>>
				...
				<div class="inside logo-and-nav clearfix">
					...
					<div class="nav-holder">
						...
						<div class="secondary-nav clearfix">
							...
							<a class="cart-icon right open" href="<?php echo wc_get_cart_url(); ?>" title="<?php _e('View your shopping cart', 'create'); ?>">
